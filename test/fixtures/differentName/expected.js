...
var OriginalName = function (_Component) {
  _inherits(OriginalName, _Component);

  function OriginalName() {
    _classCallCheck(this, OriginalName);

    return _possibleConstructorReturn(this, (OriginalName.__proto__ || Object.getPrototypeOf(OriginalName)).apply(this, arguments));
  }
...
OriginalName.displayName = 'ThisIsTheDisplayNameNow';
OriginalName.propTypes = {
  /**
   * Theme to display
   */
